...
bot = telebot.TeleBot('7779922198:AAFNKVAZh61i8c2Szu1YkokGpayjtctJGkE')
...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "You have not purchased yet purchase now from:- @RJ_official_owner."
...
def clear_users_command(message):
    ...
    if user_id in admin_id:
        ...
        response = "ʙᴜʏ:- @RJ_official_owner 🙇."
    bot.reply_to(message, response)
...
def show_recent_logs(message):
    ...
    if user_id in admin_id:
        ...
        response = "DM TO BUY: @RJ_official_owner ❄."
        bot.reply_to(message, response)
...
def start_attack_reply(message, target, port, time):
    ...
    response = f"{username}, 𝐀𝐓𝐓𝐀𝐂𝐊 𝐒𝐓𝐀𝐑𝐓𝐄𝐃.🔥🔥\n\n𝐓𝐚𝐫𝐠𝐞𝐭: {target}\n𝐏𝐨𝐫𝐭: {port}\n𝐓𝐢𝐦𝐞: {time} 𝐒𝐞𝐜𝐨𝐧𝐝𝐬\n𝐌𝐞𝐭𝐡𝐨𝐝: VIP- User of @RJ_official_owner"
    bot.reply_to(message, response)
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = ("🚫 Unauthorized Access! 🚫\n\nOops! It seems like you don't have permission to use the /bgmi command. DM TO BUY ACCESS:- @RJ_official_owner")
...
Buy From :- @RJ_official_owner
Official Channel :- https://t.me/Paidattack1997
'''
...
3. MAKE SURE YOU JOINED https://t.me/Paidattack1997 OTHERWISE NOT WORK
